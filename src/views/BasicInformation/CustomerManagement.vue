<template>
  <section class="main-content">
    <el-row>
      <span style="font-size:12px;display:inline-block;margin-bottom:20px;">客户管理</span>
      <el-col :span="24" clsss="form-content">
        ...
        <el-row type="flex" justify="end">
          <el-col :span='3' style="margin-bottom:20px;">
            <el-button type="primary" size="mini" @click='AddSupplier'>添加客户</el-button>
          </el-col>
        </el-row>
        ...
        <el-table :data="tableData" style="width: 100%" :header-cell-style="{background:'#e7edfd'}" :cell-class-name='setFirstClass'>
          ...
          <el-table-column prop="vip_user_grade_name" label="客户等级">
          </el-table-column>
