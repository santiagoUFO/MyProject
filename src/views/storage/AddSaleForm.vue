          ...
          <el-col :span="20">
            ...
            >
              ...
              <el-table-column label="条形码">
                <template slot-scope="scope">
                  <el-input
                    ...
                    @keyup.enter.native="barCodeQuery(scope.row.barcode, scope.$index)"
                  ></el-input>
                </template>
              </el-table-column>
              <el-table-column
                label="分类"
                prop="goods_group_name"
              >
              </el-table-column>
              <el-table-column
                prop="spec"
              ...
              <el-table-column label="金额">
                <template slot-scope="scope">
                  <el-input
                    :value="scope.row.goods_number*scope.row.goods_price"
                    readonly
                  ></el-input>
                </template>
              </el-table-column>
        ...
        <el-row>
          <el-form-item label="本单实收：">
            <el-input
              ...
              type='text'
              style="width:13%"
              v-model="form.total_goods_price"
            >
              <i
                slot="suffix"
                class="iconfont"
...
import { addSaleForm } from "@/api/storage/saleTicket.js";
export default {
  data() {
    return {
      value1: "",
  ...
  methods: {
    ...
    submitSave() {
      ...
      addSaleForm(this.form).then(res => {
        this.$message({
          message: "添加订单成功！",
          type: "success"
        });
